          ...
          >
            ...
            <div className="flex items-center">
             ...
             focus:outline-none focus:ring-4 focus:ring-purple-300"
              ...
              >
               <img src={icon} alt="Rocket" width={16} height={16} />
...
>
  ...
  {/* Button Content */}
  <div
    className="relative flex space-x-2 items-center z-10 rounded-full py-1 px-6"
    style={{
      background: `linear-gradient(90deg, #b6d0d5ff 0%, #d0d0d0ff 100%)`,
    }}
  >
    <span className="text-black text-base font-bold underline-offset-[6px] hover:bg-blue-300 hover:text-white">
      ...
      />
          ...
          <div className="text-center">
            <div className="relative group inline-block">
              ...
              >
                <h1
                  className="text-[20rem] font-extrabold text-black leading-none cursor-pointer hover:bg-blue-200 hover:text-white"
          ...
          <div className="relative group inline-block">
            ...
            >
              <h2
                className="font-bold mb-3 hover:bg-blue-200 hover:text-white"
                style={{
                  fontSize: "4rem",
                  fontWeight: "700",
                  color: "#F1A77D",
